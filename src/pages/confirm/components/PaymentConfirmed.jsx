			...
			<section id="" className="section-padding notificaiton-pages">
				<div className="confirm-container">
					...
					>
						<p>{data?.clientRef}</p>
						{isCopied ? (
							<small className="copied">Copied to clipboard</small>
						) : (
							<small>Reference Number</small>
						)}
					</div>
					<p>
            You will receive an email containing the reference number and
            invoice, along with the payment confirmation.
					</p>
					<p>Thank you!</p>
