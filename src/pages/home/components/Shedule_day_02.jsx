                  ...
                  <div className="tab-pane fade show active">
                    ...
                    <div className="schedule-card">
                      ...
                      <div className="schedule-card-content">
                        ...
                        {/* <div
                          className="schedule-card-body d-none d-sm-block"
                          style={{ height: "20vh" }}
                        >
                          <div className="row ml-1">
                            <div className="col-6 border-right">
                              <div className="row">
                                <h6 style={{ fontSize: "18px" }}>FinTech</h6>
                              </div>
                              <div className="row border-top pt-2 ">
                                <h6 style={{ fontSize: "14px" }}>
                                  Helping Smart cities achieve inclusive and
                                  sustainable
                                </h6>
                            ...
                            <div className="col-6">
                              ...
                              <div className="row border-top pt-2 ml-1">
                                <h6 style={{ fontSize: "14px" }}>
                                  Helping Smart cities achieve inclusive and
                                  sustainable
                                </h6>
