		...
		<div className="backdrop" style={{ display: isOpen ? 'block' : 'none' }}>
			<div className="modal" style={{ display: isOpen ? 'block' : 'none' }}>
              ...
              may register and avail the Services.
						...
						<p>
              CSSL&apos;s rights, obligations, undertakings shall be subject to
              the laws in force in Sri Lanka, as well as any directives/
              procedures of Government of Sri Lanka, and nothing contained in
              these Terms and Conditions shall be in derogation of CSSL&apos;s
              right to comply with any law enforcement agencies request or
              requirements relating to any Applicant&apos;s use of the website
              or information provided to or gathered by CSSL with respect to
              such use. Each Applicant accepts and agrees that the provision of
              details of his/her use of the Website to regulators or police or
              to any other third party in order to resolve disputes or
